    ...
    <nav className="w-[100%] h-[100px] max-w-[800px] m-auto z-10 bg-slate-200 sticky top-0 dark:bg-slate-800">
      <div className="flex justify-between h-[100%] w-[100%] py-[25px]">
        ...
        <div className="box-content relative inline-flex flex-col justify-center min-[625px]:hidden cursor-pointer h-[50px] w-[40px] px-[10px]" onClick={toggleMenu}>
          <div className={"absolute w-[40px] h-[4px] top-[14px] bg-slate-200 rounded-full ham-top " + (isOpen ? "ham-active" : "")}></div>
          <div className={"absolute w-[40px] h-[4px] top-[23px] bg-slate-200 rounded-full ham-mid " + (isOpen ? "ham-active" : "")}></div>
          <div className={"absolute w-[40px] h-[4px] bottom-[14px] bg-slate-200 rounded-full ham-bot " + (isOpen ? "ham-active" : "")}></div>
        </div>
